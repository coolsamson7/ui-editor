...
export class FontEditor implements OnChanges, OnDestroy {
    ...
    private weightValues = [undefined, 'normal', 'bold', '100', '200', '300', '300', '500', '600', '700', '800', '900'];
    private weightLabels = ['-', 'normal', 'bold', '100', '100', '200', '300', '300', '500', '600', '700', '800', '900'];

    private sizeValues = [undefined, 'inherit', 'small', 'medium', 'large'];
    private sizeLabels = ['-', 'normal', 'inherit', 'small', 'medium', 'large'];

    private familyValues = [undefined, 'Arial', 'Verdana']; // TODO
